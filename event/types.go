...
type MessageNotificationHolderType struct {
	// dezi UtcTime           xsd.DateTime     `xml:",attr"`
	UtcTime           xsd.String       `xml:",attr"`
...
// EndpointReferenceTypeReq in ws-addr
type EndpointReferenceTypeReq struct { //wsa http://www.w3.org/2005/08/addressing/ws-addr.xsd
	Address AttributedURIType `xml:"wsa:Address"`
	//ReferenceParameters ReferenceParametersType
	//Metadata            MetadataType
}

// EndpointReferenceTypeRes in ws-addr
type EndpointReferenceTypeRes struct { //wsa http://www.w3.org/2005/08/addressing/ws-addr.xsd
...
type EndpointReference EndpointReferenceTypeReq
...
type ProducerReference EndpointReferenceTypeRes

// SubscriptionReference Alias
type SubscriptionReference EndpointReferenceTypeRes
